...
This epic covers the management of societies, societies, and groups within the parish (e.g., Catholic Men Organization, Catholic Women Organization, Legion of Mary, Knights of Columbus, etc.). Includes membership tracking, leadership assignment, dues collection, and meeting management.
...
#### US-07-002: View Societies List

**As a** Parish Staff
**I want to** view all societies
...
This epic has been refactored to use "Society" instead of "PiousOrganization".
