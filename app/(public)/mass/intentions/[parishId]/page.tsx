			...
			<div className="min-h-screen pt-[80px] bg-background">
				<div className="mx-auto max-w-4xl px-4 py-32">
					...
					<p className="text-muted-foreground">
						Mass intentions are not available for this parish at
						this time.
					</p>
				</div>
			</div>
					...
					<div className="flex flex-wrap items-center justify-between gap-4">
						<div className="space-y-2">
							...
							<p className="text-sm text-muted-foreground md:text-base">
								...
								{totalIntentions !== 1 ? "s" : ""} for upcoming
								masses
							</p>
						</div>
						<Button asChild>
							<Link
								href={`/p/${parishId}/mass-intentions`}
							>
								Book an intention
							</Link>
						</Button>
