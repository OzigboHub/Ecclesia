          ...
          <Card className=" bg-primary-foreground md:col-span-2">
            <CardContent className=" pt-6">
              <div className=" flex flex-row items-center gap-3">
                ...
                <p className=" font-bold text-xl">Find Your Parish</p>
              </div>
              <div className="">
          ...
          <Card className=" w-full bg-primary/30">
            <CardContent className=" pt-6">
              <div className=" flex flex-row items-center gap-3">
                ...
                <p className=" font-bold text-xl">Parishioner Portal</p>
              </div>
              <div className="">
                ...
                <div className="mt-[10px]">
                  <Button
                    asChild
                    className="  bg-primary dark:bg-white  rounded-[15px] py-[30px] w-full">
            ...
            <div className=" ">
              ...
              <div className=" flex flex-col gap-4 mt-[20px]">
                <div className=" flex flex-row items-start gap-3">
                  ...
                  <div className="">
                    <p className=" text-[15px] font-bold">Branded Spaces</p>
                ...
                <div className="">
                  <Button asChild className=" rounded-[15px] py-[30px]">
