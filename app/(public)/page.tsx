...
export default async function LandingPage() {
  const todayLiturgy = await LiturgyService.getDailyLiturgy().catch(() => null);
  ...
  return (
    <div>
          ...
          <MaxWidthWrapper>
            <div className="flex h-[70vh] flex-col justify-center gap-4 px-4 text-white md:h-screen md:px-10">
              ...
              <p className="max-w-xl text-base md:text-lg">
                Stay connected with your parish through livestreams, interactive
                calendars and real-time community updates. Faith has no
                boundaries.
              </p>
              <div className="flex flex-col gap-3 sm:flex-row">
                <Button
                  asChild
                  className="rounded-[15px] py-6 sm:w-auto font-bold bg-primary text-primary-foreground hover:brightness-110">
                  <Link href={"/feed"}>
                    <HiMiniArrowRightCircle className="w-5 h-5" />
                    {`Today's Readings & Liturgy`}
                  </Link>
                </Button>
              </div>
            </div>
      ...
      <MaxWidthWrapper>
          ...
          <Card className="bg-[#111827] text-white md:col-span-2 border-border">
            <CardContent className="pt-6">
              <div className="flex flex-row items-center gap-3">
                ...
                <p className="font-bold text-xl text-white">Find Your Parish</p>
              </div>
              <div>
                <p className="mt-2 max-w-md text-slate-300">
                  Search for your local congregation to view their specific
                  events, updates and stewardship opportunities.
                </p>
            ...
            <CardContent className="pt-6">
              ...
              <div>
                <p className="text-muted-foreground w-full mt-[10px]">
                  Already a registered member? Access your profile, giving
                  history and ministry groups.
                </p>
                <div className="mt-[10px]">
                  <Button
                    asChild
                    className="w-full rounded-[15px] bg-primary text-primary-foreground py-6 font-bold">
        ...
        {/* Interactive Daily Liturgy & Scripture Readings Section */}
        {todayLiturgy && (
          ...
          <div className="mt-10 flex flex-col gap-8 md:flex-row md:justify-between">
            <div className="flex gap-7 items-center flex-col">
              ...
              <div className="max-w-xs text-center">
                <p>
                  Never miss a service or update. Recieve instant alerts or
                  emergency changes or upcoming special liturgies.
                </p>
              </div>
            </div>
            <div className="flex gap-7 items-center flex-col">
              ...
              <div className="max-w-xs text-center">
                <p className="">
                  A centralized hub for all ministries, mass schedules and
                  volunteer opportunities in your parish.
                </p>
              </div>
            </div>
            <div className="flex gap-7 items-center flex-col">
              ...
              <div className="max-w-xs text-center">
                <p>
                  Support your parish&apos;s mission with secure, transparent,
                  and simple one-time or recurring contributions.
                </p>
              </div>
            </div>
          </div>
        ...
        <MaxWidthWrapper>
          <div className="flex items-center flex-col">
            ...
            <p className="mt-4 max-w-xl text-center text-muted-foreground">
              A comprehensive SaaS solution built to empower and connect modern
              spiritual communities through a single, intuitive interface.
            </p>
          ...
          <div className="flex flex-col items-center gap-8 py-12 md:flex-row md:py-16">
            <div>
              <p className="text-3xl font-bold md:text-4xl text-white">
                Your Parish. Your Digital Presence. Fully Managed.
              </p>
              <div className="mt-5 flex flex-col gap-4">
                <div className="flex flex-row items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">
                      Customized layout with your parish colors, logos and
                      specific identity.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <Button asChild className="rounded-[15px] py-6">
