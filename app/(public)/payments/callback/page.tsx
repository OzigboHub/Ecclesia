      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-background border border-border rounded-lg p-6 text-center space-y-4">
          ...
          <p className="text-muted-foreground text-sm">
            No payment reference was found. If you made a payment, please
            contact the parish office with your transaction details.
          </p>
      ...
      <div className="max-w-md w-full bg-background border border-border rounded-lg p-6 text-center space-y-4">
        {isSuccess ? (
          <>
            ...
            {payment?.massIntentionId && (
              <p className="text-sm text-muted-foreground">
                Your mass intention has been submitted and will be reviewed by
                the parish.
              </p>
            )}
          </>
          ...
          <>
            ...
            <p className="text-muted-foreground text-sm">
              Your payment is still being processed. This usually completes
              within a few minutes. You&apos;ll receive a confirmation once
              it&apos;s done.
            </p>
          ...
          <>
            ...
            <p className="text-sm text-muted-foreground">
              If you were charged, please contact the parish office with the
              reference above.
            </p>
          </>
        )}
        ...
        <div className="flex flex-col sm:flex-row gap-2 pt-2">
          <Button asChild variant="outline" className="flex-1">
            <Link
              href={
                payment?.organizationId ? `/p/${payment.organizationId}` : "/"
              }>
