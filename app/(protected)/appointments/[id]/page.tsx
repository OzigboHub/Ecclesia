...
import { getAppointment, updateAppointment, cancelAppointment } from '@/app/actions/appointment.actions';
...
export default async function AppointmentDetailPage({ params }: PageProps) {
	...
	const canCancel = canEdit && appointment.status !== 'CANCELLED' && appointment.status !== 'COMPLETED';
