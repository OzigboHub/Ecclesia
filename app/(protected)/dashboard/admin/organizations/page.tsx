...
export default async function AdminOrganizationsPage() {
	...
	const parishes = organizations.filter((org: any) => org.level === "PARISH");
	const outstations = organizations.filter(
		(org: any) => org.level === "OUTSTATION",
	);
	...
	return (
		<div className="space-y-6">
			...
			<div className="space-y-4">
				...
				:	<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
						{outstations.map((outstation: any) => {
							const parentParish = organizations.find(
								(org:any) => org.id === outstation.parentId,
							);
							return (
								<Card
									key={outstation.id}
