...
const stats = [
    ...
    { name: 'Monthly Offerings', value: '₦450,000', icon: DollarSign, change: '+8%' },
            ...
            <div className="bg-background border border-border rounded-lg shadow-sm p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <button className="p-4 border border-border rounded-md hover:bg-accent hover:border-primary transition-all text-left">
                        ...
                        <p className="text-sm text-muted-foreground">Add offering or donation</p>
                    </button>
                    <button className="p-4 border border-border rounded-md hover:bg-accent hover:border-primary transition-all text-left">
                    ...
                    <button className="p-4 border border-border rounded-md hover:bg-accent hover:border-primary transition-all text-left">
                        ...
                        <p className="text-sm text-muted-foreground">Schedule mass intention</p>
                    </button>
                    <button className="p-4 border border-border rounded-md hover:bg-accent hover:border-primary transition-all text-left">
                ...
                <div className="space-y-4">
                    <div className="flex items-start space-x-3 text-sm">
                        ...
                        <div className="flex-1">
                            <p className="text-foreground">Payment recorded for Sunday offering</p>
