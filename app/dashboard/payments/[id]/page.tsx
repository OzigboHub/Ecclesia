      ...
      <Card className="print:shadow-none print:border-0">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center border-b pb-4">
            <h2 className="text-2xl font-bold">{payment.organization.name}</h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-base font-medium">{payment.payerName}</p>
              </div>
              {payment.parishioner && (
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
              ...
              {payment.payerEmail && (
                <div>
                  ...
                  <p className="text-base">{payment.payerEmail}</p>
                </div>
              )}
              {payment.payerPhone && (
                <div>
                  ...
                  <p className="text-base">{payment.payerPhone}</p>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-base font-medium">
                  ...
                  {payment.month &&
                    ` (${new Date(2000, payment.month - 1).toLocaleString(
                      "default",
                      { month: "long" }
                    )})`}
                </p>
