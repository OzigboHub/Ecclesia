...
import { Plus, Clock, CheckCircle2, XCircle, User, Info } from 'lucide-react';
...
const MOCK_APPOINTMENTS = [
	{
		id: '1',
		title: 'Wedding Counseling',
		requester: 'John & Jane Doe',
		assignedTo: 'Rev. Fr. John Doe',
	...
	},
	{
		...
		requester: 'Council Secretary',
		assignedTo: 'Rev. Fr. Peter Smith',
	...
	},
	{
		...
		assignedTo: 'Parish Secretary',
		time: '2026-01-14T11:00:00',
		status: 'CANCELLED',
		type: 'COUNSELING',
	},
];
	...
	const columns = [
		{
			header: 'Date & Time',
			accessorKey: 'time',
			cell: (row: (typeof MOCK_APPOINTMENTS)[number]) => (
