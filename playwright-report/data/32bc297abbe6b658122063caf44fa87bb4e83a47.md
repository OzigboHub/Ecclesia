...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e9]:
    - generic [ref=e10]:
      - heading "Verify Your Sign-in" [level=2] [ref=e15]
      - paragraph [ref=e16]: Enter the 6-digit code from your authenticator app.
    - textbox [ref=e18]
    - button "Verify" [ref=e19]
    - link "Use a different account" [ref=e21] [cursor=pointer]:
      - /url: /auth/login
  - region "Notifications alt+T":
    - list:
      - listitem [ref=e22]:
        - generic [ref=e26]: Verify your sign-in to continue
