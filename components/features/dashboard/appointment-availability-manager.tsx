			...
			if (!result.success) {
				...
				if (result.errors) {
					Object.entries(result.errors).forEach(
						([field, messages]) => {
							form.setError(
								field as keyof AvailabilityFormValues,
								{
									type: "server",
									message: messages[0],
								},
		...
		<div className="space-y-4 rounded-lg border bg-background p-4">
			<div>
				...
				<p className="text-xs text-muted-foreground">
					Publish specific appointment times that public visitors can
					book.
				</p>
			</div>
			...
			>
				...
				<div className="space-y-1 md:col-span-2 xl:col-span-3">
					<Label htmlFor="availability-assigned-to">
						Assigned Staff
					</Label>
					<Controller
						name="assignedToId"
