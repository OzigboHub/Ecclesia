  ...
  if (!result.success) {
    return (
      <div className="p-6 border border-destructive/50 rounded-lg bg-destructive/10">
        <p className="text-destructive">Failed to load system metrics</p>
      </div>
    );
  }
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {metrics.totalParishes} parishes, {metrics.totalOutstations}{" "}
              outstations
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {metrics.activeUsers} active ({metrics.averageUsersPerOrg} per
              org)
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {metrics.totalOrganizations > 0
                ? Math.round(metrics.totalPayments / metrics.totalOrganizations)
                : 0}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              per organization
