...
import { OrganizationTransferSelector } from "@/components/features/parishioners/organization-transfer-selector";
...
export function ParishionerEditForm({
  ...
  const form = useForm<UpdateParishionerInput>({
    ...
    defaultValues: {
      ...
      organizationId: currentOrganizationId ?? parishioner.organizationId,
    },
  });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      {canTransferOrganization && (
        <Card>
          <CardHeader>
            <CardTitle>Parish / Outstation Assignment</CardTitle>
            <CardDescription>
              Move this parishioner to another organization.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <OrganizationTransferSelector
              value={watch("organizationId") || currentOrganizationId || ""}
              onChange={(value) =>
