...
export function MassIntentionBooking() {
    ...
    const loadMasses = async (selectedDate: Date) => {
        ...
        if (res.success) {
            ...
            setAvailableMasses(res.data.filter((m: any) => m.status === 'SCHEDULED' || m.status === 'RESCHEDULED'));
        }
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 max-w-lg">
                        ...
                        <div className="space-y-2">
                            ...
                            {loadingMasses ? (
                                <div className="text-sm text-muted-foreground">Loading masses...</div>
                            ) : availableMasses.length === 0 ? (
                                <div className="text-sm text-yellow-600">No available masses for this date.</div>
                            ) : (
                            ...
                            {form.formState.errors.massId && <p className="text-red-500 text-sm">{form.formState.errors.massId.message}</p>}
                        </div>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea {...field} placeholder="Enter your prayer intention..." />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                                ...
                                <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="SPECIAL_INTENTION">Special Intention</SelectItem>
                                        </SelectContent>
                                    </Select>
                                    <FormMessage />
                                </FormItem>
                        ...
                        <Button type="submit" disabled={!form.watch('massId') || form.formState.isSubmitting}>
