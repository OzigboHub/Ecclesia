...
async function main() {
    ...
    const parishioners = [
        { firstName: 'John', lastName: 'Doe', email: 'john.doe@example.com', phone: '08012345678', gender: 'MALE', maritalStatus: 'MARRIED' },
        { firstName: 'Jane', lastName: 'Smith', email: 'jane.smith@example.com', phone: '08087654321', gender: 'FEMALE', maritalStatus: 'SINGLE' },
        { firstName: 'Peter', lastName: 'Obi', email: 'peter.obi@example.com', phone: '08011122233', gender: 'MALE', maritalStatus: 'MARRIED' },
    ]
