...
export const createSocietySchema = societyBaseSchema.extend({
	presidentId: z.string().uuid("Select a valid president"),
	secretaryId: z.string().uuid("Select a valid secretary"),
});
...
export const updateSocietySchema = societyBaseSchema.partial().extend({
	presidentId: z
		.union([
